                  ...
                  <div key={c.id} className="glass-card rounded-[2rem] p-5 hover-scale border-white/5 group relative overflow-hidden">
                    ...
                    <div className="mt-6 pt-5 border-t border-white/5 flex items-center justify-between gap-2 relative z-10">
                      <div className="flex items-center gap-1.5">
                        <ActionButton color="emerald" label="Call" icon={<svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M6 3l3 3-2 2c1.5 3 4 5.5 7 7l2-2 3 3-2 3c-6-.5-12.5-7-13-13L6 3z"/></svg>} onClick={() => onDial(c)} disabled={!c.phones?.[0]} />
