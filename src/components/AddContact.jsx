    ...
    <section className="flex flex-col min-h-0 h-full">
      <header className="px-4 pt-7 pb-5 sticky top-0 z-10 bg-black/70 backdrop-blur supports-[backdrop-filter]:bg-black/40">
        <div className="max-w-md mx-auto flex items-center">
          ...
          <h1 className="text-lg font-semibold text-center flex-1 mx-auto my-3">New contact</h1>
          <button 
            form={formId} 
            type="submit" 
      ...
      <div className="flex-1 overflow-y-auto">
        <ContactForm formId={formId} onCancel={onCancel} onSubmit={handleSubmit} submitLabel="Add" showFooter={false} allGroups={allGroups} />
      </div>
    </section>
  )
}
