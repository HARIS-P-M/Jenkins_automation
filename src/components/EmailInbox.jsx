  ...
  return (
    <div className="h-full bg-white dark:bg-[#0b0b0b] flex flex-col transition-colors">
      ...
      <div className="bg-slate-50 dark:bg-[#0e0e0e] border-b border-slate-200 dark:border-white/10 p-4 transition-colors">
        ...
        <h1 className="text-2xl font-bold text-slate-900 dark:text-white mb-4 transition-colors">📧 Email</h1>
          ...
          {!loading && !error && messages.map((message) => (
            ...
            >
              <div className="flex items-start justify-between gap-2 mb-1">
                <div className="font-medium text-slate-900 dark:text-white truncate flex items-center gap-1">
            ...
            <div className="p-6">
              ...
              {selectedMessage.attachments && selectedMessage.attachments.length > 0 && (
                <div className="mt-6 pt-4 border-t border-slate-200 dark:border-white/10">
                  <div className="text-sm font-medium text-slate-700 dark:text-gray-300 mb-3">
                    Attachments ({selectedMessage.attachments.length})
                  </div>
                  <div className="space-y-2">
                    {selectedMessage.attachments.map((att, index) => (
                      <div key={index} className="flex items-center justify-between bg-slate-100 dark:bg-[#1a1a1a] rounded-lg px-3 py-2">
                        <div className="flex items-center gap-2 flex-1 min-w-0">
                          ...
                          <span className="text-sm text-slate-800 dark:text-gray-300 truncate">{att.filename}</span>
                          <span className="text-xs text-slate-500 dark:text-gray-500 flex-shrink-0">
